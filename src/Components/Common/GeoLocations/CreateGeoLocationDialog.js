        ...
        <DialogContent>
            <FormControl variant="outlined" className={classes.formControl}>
              ...
              >
                ...
                <MenuItem id="geolocation_city" value={'cities'}>Cities</MenuItem>
                <MenuItem id="geolocation_location" value={'location'}>Locations</MenuItem>
                <MenuItem id="geolocation_area" value={'area'}>Areas</MenuItem>
                <MenuItem id="geolocation_dma" value={'dma'}>DMAs</MenuItem>
                <MenuItem id="geolocation_zipcode" value={'zipCodes'}>Zip Codes</MenuItem>
                <MenuItem id="geolocation_country" value={'countries'}>Countries</MenuItem>
                <MenuItem id="geolocation_state" value={'states'}>States</MenuItem>
              </Select>
            </FormControl>
            <FormControl variant="outlined" className={classes.formControl}>
              {
            ...
            >
                ...
                <Button id="add_location" disabled={location == ""} onClick={handleCreateClick} color="primary">
                    Add Location
                </Button>
            </DialogActions>
        </DialogContent>
