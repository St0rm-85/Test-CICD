...
import {applySchedActiveStatus, getStatusFilterStatement, 
    getEnvironment, getEnvironmentCampaignIds, getAPICall} from '../../CommonFunctions';
...
function CampaignGeoFilters(props){
    ...
    useEffect(()=>{
        getCampaignLocationList(getEnvironmentCampaignIds().carousel).then(setCampaignLocationList)
        .catch(err => err)
    ...
    return(
        ...
        // props.selectedFilter.name &&
            <ViewLinks 
                ...
                campaign_id={getEnvironmentCampaignIds().carousel}
                    ...
                    render: rowData => (
                        <Typography>
                            ...
                            >
                                <Delete 
                                    style={{color: "black"}}
                                    className="delete_carouselfilter"
                                />
                                    <span 
                                        style={{verticalAlign: "bottom",lineHeight: '36px'}}>
                                        Delete
